...
public:
  ...
  enum {
    RuleProg = 0, RuleCompUnit = 1, RuleDecl = 2, RuleConstDecl = 3, RuleBType = 4, 
    ...
    RuleUnaryExp = 22, RuleUnaryOp = 23, RuleFuncRParams = 24, RuleFuncRParam = 25, 
  ...
  class  Float_LiteralContext : public NumberContext {
  public:
    Float_LiteralContext(NumberContext *ctx);
  ...
  class  Int_LiteralContext : public NumberContext {
  public:
    Int_LiteralContext(NumberContext *ctx);
